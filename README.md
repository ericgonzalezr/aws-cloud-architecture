...
├── docs/
│   ├── memoria.pdf        Memoria completa del proyecto
...
IP, identificadores de recursos, nombres de claves ni huellas de servidor. La
infraestructura descrita fue destruida al finalizar el proyecto.
