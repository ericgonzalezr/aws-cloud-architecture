...
Screenshots in the report are sanitised: they contain no public IP addresses,
account identifiers, key names, host fingerprints or email addresses. The
infrastructure described was destroyed at the end of the project, so the
private addresses and resource IDs still visible identify nothing.
